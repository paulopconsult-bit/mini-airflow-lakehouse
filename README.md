...
├── 03_processado_bronze  <-- Bronze Outbound: Dados consolidados em Parquet
...
Storage Híbrido: Uso do Google Drive sincronizado offline para processamento em velocidade de disco local.
